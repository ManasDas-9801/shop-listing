        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link btn btn-warning text-light" data-bs-toggle="modal"
                            data-bs-target="#catMaodel">Add Cateogries</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <form action="{{ route('Save.Cat') }}" method="post" id="basic-form">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="catMaodelLabel">Add Cateogery Table </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <label for="cat_name"> <b>Cateogry Name</b> </label>
                                    ...
                                    <form action="{{ route('Save.Shop') }}" method="post">
                                        ...
                                        @enderror
                                          ...
                                          <div class="row">
                                             <div class="col-10">
                                                <div class="select">
                                                    <label for="Cateogry Name"> <b>Cateogries Name</b> </label>
                                             ...
                                             <div class="col-2">
                                                <button id="more" class="btn btn-primary mt-4 mb-2"> +</button>
                                             </div>
                                          </div>
